(function() {
	try {
		...
		n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "47584ecc-4ccd-4471-b849-31a95ad7db91", e._sentryDebugIdIdentifier = "sentry-dbid-47584ecc-4ccd-4471-b849-31a95ad7db91");
	} catch (e) {}
})();
...
var { createContext: createContext$1, useContext: useContext$1 } = await importShared("react");
var TabContext = createContext$1(void 0);
var useCurrentTabId = () => useContext$1(TabContext);
//#endregion
...
var { useCallback: useCallback$8, useEffect: useEffect$11, useMemo: useMemo$4, useState: useState$11 } = await importShared("react");
...
function TabModal({ isOpen, onOpenChange, children, size = "cover", isDismissable = true, backdropVariant, dialogClassName, containerClassName, isKeyboardDismissDisabled, tabId: explicitTabId }) {
	...
	const [targetContainer, setTargetContainer] = useState$11(() => {
		if (typeof document === "undefined") return null;
		return resolvedTabId ? document.getElementById(`${resolvedTabId}_wrapper`) : null;
	});
	const currentRunningCard = useMemo$4(() => runningCards.find((card) => card.tabId === (resolvedTabId ?? activeTab)), [
		runningCards,
		resolvedTabId,
		activeTab
	]);
...
var i$20 = t$24((t, i) => (0, import_jsx_runtime.jsxs)(a, {
	ref: i,
	...t,
...
var i$19 = t$23((t, i) => (0, import_jsx_runtime.jsxs)(a, {
	ref: i,
	...t,
...
var i$18 = t$22((t, i) => (0, import_jsx_runtime.jsxs)(a, {
	ref: i,
	...t,
...
var i$17 = t$21((t, i) => (0, import_jsx_runtime.jsxs)(a, {
	ref: i,
	...t,
...
var i$16 = t$20((t, i) => (0, import_jsx_runtime.jsxs)(a, {
	ref: i,
	...t,
...
var i$15 = t$19((t, i) => (0, import_jsx_runtime.jsxs)(a, {
	ref: i,
	...t,
...
var i$14 = t$18((t, i) => (0, import_jsx_runtime.jsxs)(a, {
	ref: i,
	...t,
...
var i$13 = t$17((t, i) => (0, import_jsx_runtime.jsxs)(a, {
	ref: i,
	...t,
...
var i$12 = t$16((t, i) => (0, import_jsx_runtime.jsxs)(a, {
	ref: i,
	...t,
...
var i$11 = t$15((t, i) => (0, import_jsx_runtime.jsxs)(a, {
	ref: i,
	...t,
...
var i$10 = t$14((t, i) => (0, import_jsx_runtime.jsxs)(a, {
	ref: i,
	...t,
...
var i$9 = t$13((t, i) => (0, import_jsx_runtime.jsxs)(a, {
	ref: i,
	...t,
...
var i$8 = t$12((t, i) => (0, import_jsx_runtime.jsxs)(a, {
	ref: i,
	...t,
...
var i$7 = t$11((t, i) => (0, import_jsx_runtime.jsxs)(a, {
	ref: i,
	...t,
...
var i$6 = t$10((t, i) => (0, import_jsx_runtime.jsxs)(a, {
	ref: i,
	...t,
...
var i$5 = t$9((t, i) => (0, import_jsx_runtime.jsxs)(a, {
	ref: i,
	...t,
...
var r$8 = t$8((t, r) => (0, import_jsx_runtime.jsx)(a, {
	ref: r,
	...t,
...
var r$7 = t$7((t, r) => (0, import_jsx_runtime.jsx)(a, {
	ref: r,
	...t,
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: creationSuccess ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card$3, {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(i$20, { className: "size-16 text-emerald-500" }),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								children: createdPaths.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(i$15, { className: "size-3.5 shrink-0 text-LynxBlue/80 mt-0.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: p })]
								}, p))
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card$2.Footer, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button$8, {
					...
					children: [installed ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(i$10, { className: "size-4" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(i$17, { className: "size-4" }), installed ? "Configure / Re-install" : "Install"]
				})
			})
		]
	});
								...
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button$7, {
											...
											isIconOnly: true,
											children: installed ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(i$10, { className: "size-3.5 text-semi-muted" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(i$17, { className: "size-3.5 text-foreground" })
										})
									]
								}, `${r.repo}-${skill.name}`);
							})
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tabs$2.ListContainer, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tabs$2.List, { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tabs$2.Tab, {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(i$8, { className: "size-4" }),
									"All Time",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tabs$2.Tab, {
								...
								className: "flex items-center gap-1.5  text-nowrap",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(i$5, { className: "size-4" }),
									"Official",
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tabs$2.Indicator, {})
								]
							})
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(InputGroup$1.Input, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button$5, {
								...
								isIconOnly: true,
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(i$15, { className: "size-4 text-semi-muted hover:text-white" })
							})
						})]
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center gap-2",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(i$15, { className: "size-4 text-LynxBlue" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					children: projectDirs.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(i$7, { className: "size-3.5" })
							})]
						}, dir);
					})
				}),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tooltip, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tooltip.Trigger, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button$3, {
									...
									isIconOnly: true,
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(i$15, { className: "size-4" })
								}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tooltip.Content, {
									showArrow: true,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tooltip, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tooltip.Trigger, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button$3, {
									...
									children: isDeleting ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Spinner$3, { size: "sm" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(i$7, { className: "size-4" })
								}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tooltip.Content, {
									showArrow: true,
...
var { useCallback: useCallback$4, useEffect: useEffect$5, useMemo: useMemo$1, useRef: useRef$1, useState: useState$4 } = await importShared("react");
...
function useBulkActions(installedSkills, onRefreshInstalled) {
	...
	const confirmBulkDeleteTimeoutRef = useRef$1(null);
	useEffect$5(() => {
		return () => {
...
function useSkillsGroups(installedSkills, filterQuery, groupBy) {
	...
	const folderGroups = useMemo(() => {
		...
		return Object.entries(map).map(([folderPath, skills]) => ({
			id: folderPath,
			title: folderPath,
			icon: React.createElement(i$15, { className: "size-4 text-LynxBlue" }),
			skills
		}));
	...
	const scopeGroups = useMemo(() => {
		...
		if (map.project.length > 0) groups.push({
			id: "project",
			title: "Project Scope",
			icon: React.createElement(i$12, { className: "size-4 text-LynxBlue" }),
			skills: map.project
		});
	...
	const agentGroups = useMemo(() => {
		...
		const groups = Object.entries(map).map(([agentName, skills]) => ({
			...
			icon: React.createElement(i$6, { className: "size-4 text-LynxPurple" }),
			skills
		}));
		if (noAgentSkills.length > 0) groups.push({
			id: "none",
			title: "Common (No Target Agent)",
			icon: React.createElement(i$6, { className: "size-4 text-semi-muted" }),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Modal$1.Body, {
				...
				children: [
					...
					installResult && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [installResult.success ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(i$20, { className: "size-4 shrink-0 mt-0.5 text-success" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(i$13, { className: "size-4 shrink-0 mt-0.5 text-danger" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "break-all",
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tabs.ListContainer, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tabs.List, { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tabs.Tab, {
								...
								className: "flex items-center gap-2",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(i$18, { className: "size-4" }),
									"Discover",
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tabs.Indicator, {})
								]
							}),
...
var { Fragment, useEffect: useEffect$1, useState } = await importShared("react");
/**
...
//# sourceMappingURL=Extension-BHxlAhLi.js.map